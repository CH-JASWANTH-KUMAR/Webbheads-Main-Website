...
export default function AboutUs() {
  ...
  const roleMap: Record<string, string> = {
    "Founder and CEO": "స్థాపకుడు మరియు సిఇఒ",
  ...
  const detailMap: Record<string, string> = {
    ...
    "member-2": "కాలేజీలో రెండో సంవత్సరంలో ఉన్నా ఇప్పటికే స్టాక్‌లో లోతుగా ఉన్నాడు. జస్వంత్ అది పని చేస్తుంది అనే దగ్గర ఆగే డెవలపర్ కాదు - అది ఎందుకు పని చేస్తుందో, ఎలా వేగంగా చేయవచ్చో అడుగుతాడు. ప్రొడక్ట్స్ ఎలా నిర్మించబడతాయో అనే పూర్తి చిత్రం పట్ల ఆకర్షితుడై, నిజంగా షిప్ అయ్యే దానిపై పని చేయడానికి వెబ్హెడ్స్ కి వచ్చాడు. రియల్ ఎస్టేట్ టెక్ అతని రాడార్‌లో లేదు - అంతరాన్ని చూసే వరకు. ఇప్పుడు దాన్ని విస్మరించలేడు.",
    "member-3": "పవన్ రెండో సంవత్సరంలో ప్రవేశిస్తూనే ముఖ్యమైన వాటిని నిర్మించాలనుకున్నాడు - కేవలం అసైన్‌మెంట్లు కాదు, నిజమైన యూజర్లతో నిజమైన ప్రొడక్ట్స్. వెబ్హెడ్స్ లో అతను సరిగ్గా అదే చేస్తున్నాడు, లైవ్ క్లయింట్ అనుభవాలను నడిపే కోడ్ రాస్తున్నాడు. వేగంగా కదులుతాడు, వ్యవస్థలలో ఆలోచిస్తాడు, మరియు డెడ్‌లైన్ నిజమైనప్పుడు జట్టులో అత్యంత నమ్మకమైన వ్యక్తుల్లో ఒకడు.",
    "member-4": "కాలేజీలో లో నాలుగు సంవత్సరాలు అంటే రెవంత్ చాలా మంది డెవలపర్లు ఎలా ఆలోచిస్తారో చూశాడు - మరియు భిన్నంగా ఆలోచించాలని నిర్ణయించుకున్నాడు. చాలా మంది ఇంటర్న్‌ల కంటే ఎక్కువ అనుభవంతో, అతను తన కోడ్‌లో పరిపక్వతను చూపిస్తాడు: శుభ్రమైన నిర్మాణం, ఆలోచనాత్మక నిర్ణయాలు, ఏదీ నిర్లక్ష్యంగా లేదు. వెబ్హెడ్స్ లో అతను కేవలం పేజీలు నిర్మించడం లేదు, గ్రాడ్యుయేషన్ తర్వాత చెప్పుకోదగిన దానిగా విశ్వవిద్యాలయంలో చివరి అధ్యాయాన్ని నిర్మిస్తున్నాడు.",
    "member-5": "శ్రీవిద్య వెబ్హెడ్స్ యొక్క ప్రపంచానికి గొంతు. సేల్స్ మరియు మార్కెటింగ్ నేపథ్యంతో, ఆమె ప్రజలతో కనెక్ట్ అవడం మరియు ప్రతిధ్వనించే కథలు చెప్పడం ఎలాగో తెలుసు. ఆమె కేవలం అమ్మడం గురించి కాదు - సంబంధాలు నిర్మించడం మరియు ఏదైనా అర్థం కలిగిన బ్రాండ్ సృష్టించడం గురించి. వెబ్హెడ్స్ లో, ఆమె మనల్ని కేవలం మరొక రియల్ ఎస్టేట్ టెక్ కంపెనీగా కాకుండా మరిన్నింటిగా చేసే కథనాన్ని రూపొందిస్తోంది.",
  };
              ...
              <div>
                ...
                <p className={`mt-4 text-sm md:text-base leading-relaxed ${detailTextColor}`}>
                  {tr(
                    ...
                    detailMap[selectedMember.id] || bioMap[selectedMember.bio] || "సభ్యుడి వివరమైన వివరణను ఇక్కడ చేర్చండి."
                  )}
                </p>
              </div>
            </div>
